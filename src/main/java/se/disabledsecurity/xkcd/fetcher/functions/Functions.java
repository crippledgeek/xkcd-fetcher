...
public final class Functions {
    ...
    public static final ToIntFunction<String> toIntUnboxed = Integer::parseInt;
    public static final ToIntFunction<Integer> toUnboxed = Integer::intValue;

    public static final Function3<String, String, String, LocalDate> toDate =
            (y, m, d) -> LocalDate.of(
                    toIntUnboxed.applyAsInt(y),
                    toIntUnboxed.applyAsInt(m),
                    toIntUnboxed.applyAsInt(d)
            );

    public static final Function<String, Either<Throwable, URL>> toUrl = urlString ->
            Option.of(urlString)
    ...
    public static final Function<String, Pattern> compilePattern = Pattern::compile;
